...
if(@mysql_num_rows($resultac) >= 1)
{
  ...
  echo "<td>&nbsp;"  . $i . "</td>";
		...
		echo "<td>&nbsp;" . $row['result'] . "</td>";
	   	echo "<td>&nbsp;<a href='viewrecords.php?slid=$row[examid]&view=examination'>
	   	<img  src='images/view.png' width='32' height='32' /></a> <a href='examupdate.php?exid=$row[examid]'> 
	   	<img src='images/edit.png' width='32' height='32' /></a> . </td>";
  echo "</tr>&nbsp;";
  $i++;
  }
  $first=$_GET[first]-10;
